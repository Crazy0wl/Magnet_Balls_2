...
namespace MB_Engine
{
    public class FrozenBall : BaseBonus
    {
        public MeshRenderer[] renderers;
        public Rigidbody[] bodies;
        
        public override BallType BonusType { get { return BallType.Frozen; } }
        ...
        public IEnumerator EmitRoutine(float delay, Vector2 force)
        {
            ...
            ball.Destroy();
            Vector3 force3D = new Vector3(force.x, force.y, -force.magnitude);
            for (int i = 0; i < count; i++)
            {
                Rigidbody body = bodies[i];
                body.velocity = vel;
            ...
            PlaySound("ballsCrack", Random.Range(1.2f, 1.3f), 0f, 1f);
        }
    }
}